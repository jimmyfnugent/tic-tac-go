...
public class TicTacGo extends Activity {
      ...
      public void onClick(View v) {
        ...
        pieceClicked = new OnClickListener() {
          public void onClick(View v) {
            ...
            // Set the location for the new Piece
            board.makePiece(((LayoutParams) v.getLayoutParams()).gravity);
  ...
  private void play() {
    ...
    if ((board.getTurn() == Player.X && isCPU1) || (board.getTurn() == Player.O && isCPU2)) {
      // CPU Move
      CPUMove();
      play();
    }
